...
/* Bank 2 */
#define ACCEL_CONFIG_STATIC2 (REG_BANK2_OFFSET | 0x03)
#define ACCEL_CONFIG_STATIC3 (REG_BANK2_OFFSET | 0x04)
#define ACCEL_CONFIG_STATIC4 (REG_BANK2_OFFSET | 0x05)
...
#define ICM42686_BIT_GYRO_UI_FS_4000   0x00
#define ICM42686_BIT_GYRO_UI_FS_2000   0x01
#define ICM42686_BIT_GYRO_UI_FS_1000   0x02
#define ICM42686_BIT_GYRO_UI_FS_500    0x03
#define ICM42686_BIT_GYRO_UI_FS_250    0x04
#define ICM42686_BIT_GYRO_UI_FS_125    0x05
#define ICM42686_BIT_GYRO_UI_FS_62_5   0x06
#define ICM42686_BIT_GYRO_UI_FS_31_25  0x07

#define ICM42688_BIT_GYRO_UI_FS_2000   0x00
#define ICM42688_BIT_GYRO_UI_FS_1000   0x01
#define ICM42688_BIT_GYRO_UI_FS_500    0x02
#define ICM42688_BIT_GYRO_UI_FS_250    0x03
#define ICM42688_BIT_GYRO_UI_FS_125    0x04
#define ICM42688_BIT_GYRO_UI_FS_62_5   0x05
#define ICM42688_BIT_GYRO_UI_FS_31_25  0x06
#define ICM42688_BIT_GYRO_UI_FS_15_625 0x07
...
#define ICM42686_BIT_ACCEL_UI_FS_32   0x00
#define ICM42686_BIT_ACCEL_UI_FS_16   0x01
#define ICM42686_BIT_ACCEL_UI_FS_8    0x02
#define ICM42686_BIT_ACCEL_UI_FS_4    0x03
#define ICM42686_BIT_ACCEL_UI_FS_2    0x04

#define ICM42688_BIT_ACCEL_UI_FS_16   0x00
#define ICM42688_BIT_ACCEL_UI_FS_8    0x01
#define ICM42688_BIT_ACCEL_UI_FS_4    0x02
#define ICM42688_BIT_ACCEL_UI_FS_2    0x03
...
#define MASK_FIFO_THS_INT_CLEAR	 GENMASK(3, 2)
#define BIT_THS_INT_CLR_ON_STSRD	BIT(2)
#define BIT_THS_INT_CLR_ON_FIFORD	BIT(3)

#define MASK_FIFO_FULL_INT_CLR GENMASK(1, 0)
#define BIT_FULL_INT_CLR_ON_STSRD	BIT(0)
#define BIT_FULL_INT_CLR_ON_FIFORD	BIT(1)
...
#define ACCEL_AAF_DELT_SET_585HZ	BIT(1) | BIT(3) | BIT(4)
#define ACCEL_AAF_DELT_CLEAR_585HZ BIT(2) | BIT(5) | BIT(6)
#define ACCEL_AAF_DIS BIT(0)

/* Bank2 ACCEL_CONFIG_STATIC3 */
#define MASK_ACCEL_AAF_DELTSQR_LSB   GENMASK(7, 0)

#define ACCEL_AAF_DELTSQR_LSB_SET_585HZ	BIT(1) | BIT(3) | BIT(5) | BIT(7)
#define ACCEL_AAF_DELTSQR_LSB_CLEAR_585HZ	BIT(0) | BIT(2) | BIT(4) | BIT(6)

/* Bank2 ACCEL_CONFIG_STATIC4 */
#define MASK_ACCEL_AAF_BITSHIFT   GENMASK(7, 4)

#define ACCEL_AAF_BITSHIFT_SET_585HZ	BIT(7)
#define ACCEL_AAF_BITSHIFT_CLEAR_585HZ	BIT(4) | BIT(5) | BIT(6)

#define MASK_ACCEL_AAF_DELTSQR_MSB   GENMASK(3, 0)
#define ACCEL_AAF_DELTSQR_SET_MSB 0
#define ACCEL_AAF_DELTSQR_CLEAR_MSB BIT(0) | BIT(1) | BIT(2) | BIT(3)

/* Bank1 GYRO_CONFIG_STATIC2 */
#define GYRO_AAF_DIS	BIT(1)
#define GYRO_NF_DIS	BIT(0)

/* Bank1 GYRO_CONFIG_STATIC3 */
#define MASK_GYRO_AAF_DELT   GENMASK(5, 0)

#define GYRO_AAF_DELT_SET_585HZ  BIT(0) | BIT(2) | BIT(3)
#define GYRO_AAF_DELT_CLEAR_585HZ BIT(1) | BIT(4) | BIT(5)

/* Bank1 GYRO_CONFIG_STATIC4 */
#define MASK_GYRO_AAF_DELTSQR_LSB   GENMASK(7, 0)

#define GYRO_AAF_DELTSQR_LSB_SET_585HZ BIT(1) | BIT(3) | BIT(5) | BIT(7)
#define GYRO_AAF_DELTSQR_LSB_CLEAR_585HZ BIT(0) | BIT(2) | BIT(4) | BIT(6)

/* Bank1 GYRO_CONFIG_STATIC5 */
#define MASK_GYRO_AAF_BITSHIFT   GENMASK(7, 4)

#define GYRO_AAF_BITSHIFT_SET_585HZ	BIT(7)
#define GYRO_AAF_BITSHIFT_CLEAR_585HZ	BIT(4) | BIT(5) | BIT(6)

#define MASK_GYRO_AAF_DELTSQR_MSB   GENMASK(3, 0)

#define GYRO_AAF_DELTSQR_MSB_SET_585HZ	0
#define GYRO_AAF_DELTSQR_MSB_CLEAR_585HZ BIT(0) | BIT(1) | BIT(2) | BIT(3)
