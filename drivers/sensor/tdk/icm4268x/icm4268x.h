...
{
	if (g >= 32) {
		return ICM42686_DT_ACCEL_FS_32;
	} else if (g >= 16) {
		return ICM42686_DT_ACCEL_FS_16;
	} else if (g >= 8) {
		return ICM42686_DT_ACCEL_FS_8;
	} else if (g >= 4) {
		return ICM42686_DT_ACCEL_FS_4;
	} else {
		return ICM42686_DT_ACCEL_FS_2;
	}
}
...
static inline void icm42686_accel_reg_to_fs(uint8_t fs, struct sensor_value *out)
{
	switch (fs) {
...
static inline uint8_t icm42686_gyro_fs_to_reg(uint16_t dps)
{
	if (dps >= 4000) {
		return ICM42686_DT_GYRO_FS_4000;
	} else if (dps >= 2000) {
		return ICM42686_DT_GYRO_FS_2000;
	} else if (dps >= 1000) {
		return ICM42686_DT_GYRO_FS_1000;
	} else if (dps >= 500) {
		return ICM42686_DT_GYRO_FS_500;
	} else if (dps >= 250) {
		return ICM42686_DT_GYRO_FS_250;
	} else if (dps >= 125) {
		return ICM42686_DT_GYRO_FS_125;
	} else if (dps >= 62) {
		return ICM42686_DT_GYRO_FS_62_5;
	} else {
		return ICM42686_DT_GYRO_FS_31_25;
	}
}
...
static inline void icm42686_gyro_reg_to_fs(uint8_t fs, struct sensor_value *out)
{
	switch (fs) {
...
/**
 * @brief Convert icm42686 accelerometer value to useful g values
 *
 ...
 */
static inline void icm42686_accel_g(struct icm4268x_cfg *cfg, int32_t in, int32_t *out_g,
				    uint32_t *out_ug)
{
	int32_t sensitivity;
 ...
 * @param out_ug micro (1/1000000) of a G output as uint32_t
 */
static inline void icm42688_accel_g(struct icm4268x_cfg *cfg, int32_t in, int32_t *out_g,
				    uint32_t *out_ug)
{
	int32_t sensitivity;
...
/**
 * @brief Convert icm42686 gyroscope value to useful deg/s values
 *
 * @param cfg icm4268x_cfg current device configuration
 * @param in raw data value in int32_t format
 ...
 */
static inline void icm42686_gyro_dps(const struct icm4268x_cfg *cfg, int32_t in, int32_t *out_dps,
				     uint32_t *out_udps)
{
	int64_t sensitivity; /* value equivalent for 10x gyro reading deg/s */
 ...
 * @param out_udps micro (1/1000000) deg/s as uint32_t
 */
static inline void icm42688_gyro_dps(const struct icm4268x_cfg *cfg, int32_t in, int32_t *out_dps,
				     uint32_t *out_udps)
{
	int64_t sensitivity;
...
/**
 * @brief Convert icm42686 accelerometer value to useful m/s^2 values
 *
 * @param cfg icm4268x_cfg current device configuration
 * @param in raw data value in int32_t format
 ...
 */
static inline void icm42686_accel_ms(const struct icm4268x_cfg *cfg, int32_t in, int32_t *out_ms,
				     int32_t *out_ums)
{
	int64_t sensitivity;
 ...
 * @param out_ums micrometers/s^2 output as uint32_t
 */
static inline void icm42688_accel_ms(const struct icm4268x_cfg *cfg, int32_t in, int32_t *out_ms,
				     int32_t *out_ums)
{
	int64_t sensitivity;
...
/**
 * @brief Convert icm42686 gyroscope value to useful rad/s values
 *
 * @param cfg icm4268x_cfg current device configuration
 * @param in raw data value in int32_t format
 ...
 */
static inline void icm42686_gyro_rads(const struct icm4268x_cfg *cfg, int32_t in, int32_t *out_rads,
				      int32_t *out_urads)
{
	int64_t sensitivity;
 ...
 * @param out_urads microrad/s as uint32_t
 */
static inline void icm42688_gyro_rads(const struct icm4268x_cfg *cfg, int32_t in, int32_t *out_rads,
				      int32_t *out_urads)
{
	int64_t sensitivity;
 ...
 */
static inline void icm4268x_temp_c(int32_t in, int32_t *out_c, uint32_t *out_uc)
{
