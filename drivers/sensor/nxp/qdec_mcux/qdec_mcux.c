...
#define QDEC_MCUX_MUX_CONTROL_DEFINE_IDX(node_id, pha, idx)		\
	MUX_CONTROL_DT_SPEC_DEFINE_BY_IDX(node_id, idx)
#define QDEC_MCUX_MUX_CONTROL_DEFINE_ALL(n)				\
	DT_INST_FOREACH_PROP_ELEM(n, mux_states,				\
		QDEC_MCUX_MUX_CONTROL_DEFINE_IDX)
DT_INST_FOREACH_STATUS_OKAY(QDEC_MCUX_MUX_CONTROL_DEFINE_ALL)

#define QDEC_MCUX_MUX_CONTROL_GET_IDX(node_id, pha, idx)		\
	MUX_CONTROL_DT_GET_BY_IDX(node_id, idx)
#define QDEC_MCUX_MUX_CONTROL_LIST_DEFINE(n)					\
	static struct mux_control *qdec_##n##_muxes[] = {				\
	DT_INST_FOREACH_PROP_ELEM_SEP(n, mux_states,					\
				QDEC_MCUX_MUX_CONTROL_GET_IDX, (,))	\
	};
DT_INST_FOREACH_STATUS_OKAY(QDEC_MCUX_MUX_CONTROL_LIST_DEFINE)

#define QDEC_MCUX_GET_MUX_LIST(n) qdec_##n##_muxes
...
#define QDEC_MCUX_INIT(n)							\
	...
	static const struct qdec_mcux_config qdec_mcux_##n##_config = {		\
		...
		.mux_controls = QDEC_MCUX_GET_MUX_LIST(n),			\
