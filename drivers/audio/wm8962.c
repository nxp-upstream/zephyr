...
{
	const uint16_t val = WM8962_REGVAL_IN_VOL(0, volume);
...
{
	const uint16_t val = WM8962_REGVAL_IN_VOL(mute, 0);
	const uint16_t mask = WM8962_REGMASK_IN_MUTE;
...
static int wm8962_apply_properties(const struct device *dev)
{
	...
	wm8962_update_reg(dev, WM8962_REG_LOUT2, WM8962_REGVAL_OUT_VOL(1, 0, 0),
			  WM8962_REGMASK_OUT_VU);
