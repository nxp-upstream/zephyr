...
static int da7212_clock_mode_config(const struct device *dev, audio_dai_cfg_t *cfg)
{
	...
	if ((cfg->i2s.options & I2S_OPT_FRAME_CLK_SLAVE) == 0) {
		...
		case 16: val = DIALOG7212_DAI_BCLKS_PER_WCLK_BCLK32; break;
		case 32: val = DIALOG7212_DAI_BCLKS_PER_WCLK_BCLK64; break;
		case 64: val = DIALOG7212_DAI_BCLKS_PER_WCLK_BCLK128; break;
		case 128: val = DIALOG7212_DAI_BCLKS_PER_WCLK_BCLK256; break;
		default:
...
static int da7212_audio_format_config(const struct device *dev, audio_dai_cfg_t *cfg)
{
	...
	case 8000: val = DIALOG7212_SR_8KHZ; break;
	case 11025: val = DIALOG7212_SR_11_025KHZ; break;
	case 12000: val = DIALOG7212_SR_12KHZ; break;
	case 16000: val = DIALOG7212_SR_16KHZ; break;
	case 22050: val = DIALOG7212_SR_22KHZ; break;
	case 24000: val = DIALOG7212_SR_24KHZ; break;
	case 32000: val = DIALOG7212_SR_32KHZ; break;
	case 44100: val = DIALOG7212_SR_44_1KHZ; break;
	case 48000: val = DIALOG7212_SR_48KHZ; break;
	case 88200: val = DIALOG7212_SR_88_2KHZ; break;
	case 96000: val = DIALOG7212_SR_96KHZ; break;
	default:
	...
	/* Word length */
	switch (cfg->i2s.word_size) {
	case 16: val = DIALOG7212_DAI_WORD_LENGTH_16B; break;
	case 20: val = DIALOG7212_DAI_WORD_LENGTH_20B; break;
	case 24: val = DIALOG7212_DAI_WORD_LENGTH_24B; break;
	case 32: val = DIALOG7212_DAI_WORD_LENGTH_32B; break;
	default:
		LOG_ERR("Word size %d not supported", cfg->i2s.word_size);
		return -EINVAL;
	}
