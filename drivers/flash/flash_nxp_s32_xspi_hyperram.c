...
#define FLASH_NXP_S32_XSPI_MASTER_CLOCK_TYPE(n)					\
	_CONCAT(XSPI_IP_HR_MASTER_CLOCK_TYPE_,					\
		DT_INST_STRING_UPPER_TOKEN(n, master_locked_type))

#define FLASH_NXP_S32_XSPI_DRV_STRENGTH(n)							\
	(DT_INST_PROP(n, drive_strength_ohm) == 1 ? XSPI_IP_HR_DRV_STRENGTH_001 :		\
	(DT_INST_PROP(n, drive_strength_ohm) == 2 ? XSPI_IP_HR_DRV_STRENGTH_002 :		\
	(DT_INST_PROP(n, drive_strength_ohm) == 3 ? XSPI_IP_HR_DRV_STRENGTH_003 :		\
	(DT_INST_PROP(n, drive_strength_ohm) == 4 ? XSPI_IP_HR_DRV_STRENGTH_004 :		\
	(DT_INST_PROP(n, drive_strength_ohm) == 5 ? XSPI_IP_HR_DRV_STRENGTH_005 :		\
	(DT_INST_PROP(n, drive_strength_ohm) == 6 ? XSPI_IP_HR_DRV_STRENGTH_006 :		\
	(DT_INST_PROP(n, drive_strength_ohm) == 7 ? XSPI_IP_HR_DRV_STRENGTH_007 :		\
...
#define FLASH_NXP_S32_XSPI_REFRESH_INTERVAL(n)							\
	(DT_INST_PROP(n, refresh_interval) == 1 ? XSPI_IP_HR_ARRAY_REFRESH_001 :		\
	(DT_INST_PROP(n, refresh_interval) == 2 ? XSPI_IP_HR_ARRAY_REFRESH_002 :		\
	(DT_INST_PROP(n, refresh_interval) == 3 ? XSPI_IP_HR_ARRAY_REFRESH_003 :		\
