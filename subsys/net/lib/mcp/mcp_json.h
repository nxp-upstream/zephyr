 ...
 * - For integer IDs: stored without quotes (e.g., "123")
 * - For string IDs: stored with quotes (e.g., "\"abc\"")
 ...
 * @param id JSON-RPC request ID (as string, with quotes if originally string).
