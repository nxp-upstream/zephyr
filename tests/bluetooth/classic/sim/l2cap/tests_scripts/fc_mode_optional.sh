...
test_case_name="bluetooth.classic.sim.l2cap.flow_control.mode_optional"
...
ARGS=("--peer_bd_address=${BD_ADDR[1]}" \
      "-test=l2cap_server::test_06_fc_mode_optional")
...
ARGS=("--peer_bd_address=${BD_ADDR[0]}" \
      "-test=l2cap_client::test_06_fc_mode_optional")
