...
test_case_name="bluetooth.classic.sim.l2cap.retransmission.mode_optional"
BUMBLE_CONTROLLERS_LOG="$TEST_OUTPUT_DIR/bumble_${BOARD_SANITIZED}_${test_case_name}.log"
...
ARGS=("--peer_bd_address=${BD_ADDR[1]}" \
      "-test=l2cap_server::test_04_ret_mode_optional")
...
ARGS=("--peer_bd_address=${BD_ADDR[0]}" \
      "-test=l2cap_client::test_04_ret_mode_optional")
