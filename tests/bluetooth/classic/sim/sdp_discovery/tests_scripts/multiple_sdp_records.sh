...
test_case_name="bluetooth.classic.sim.sdp.discover.multiple_records"
...
ARGS=("--peer_bd_address=${BD_ADDR[1]}" \
      "-test=sdp_server::test_04_multiple_sdp_records")
...
ARGS=("--peer_bd_address=${BD_ADDR[0]}" \
      "-test=sdp_client::test_04_multiple_sdp_records")
