...
def test_l2cap_fc_mode_TC01(client, server):
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = basic, mode_option = false'
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = basic, mode_option = true'
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = ret, mode_option = false. stack support eret.',
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = ret, mode_option = true. stack support eret'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} ret {MODE_OPTION}',
        f'It is enhance retransmission mode',
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}',
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = fc, mode_option = false. stack support eret.'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} fc',
        f'It is enhance retransmission mode',
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}',
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = fc, mode_option = true. stack support eret.'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} fc {MODE_OPTION}',
        f'It is enhance retransmission mode',
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}',
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = eret, mode_option = false. stack support eret.'
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = eret, mode_option = true. stack support eret.'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} eret {MODE_OPTION}',
        f'It is enhance retransmission mode',
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}',
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = stream, mode_option = false'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} stream',
        f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected',
    )

    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = stream, mode_option = true.'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} stream {MODE_OPTION}',
        f'It is enhance retransmission mode',
    )
...
def test_l2cap_fc_mode_TC02(client, server):
    ...
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} basic', f'It is basic mode'
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}',
        f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected',
    ...
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} stream', f'It is streaming mode'
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}',
        f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected',
...
def test_l2cap_fc_mode_TC03(client, server):
    ...
    client.exec_command(
        f'l2cap_br send {L2CAP_CHAN_IUT_ID_RET} {data1}  {str(hex(len(data1)))[2:]}'
    )
    ...
    client.exec_command(
        f'l2cap_br send {L2CAP_CHAN_IUT_ID_RET} {data2}  {str(hex(len(data2)))[2:]}'
    )
    ...
    client.iexpect(
        f'l2cap_br send {L2CAP_CHAN_IUT_ID_RET} {data3}  {str(hex(len(data3)))[2:]}',
        f"RNR p=0 f=0 on chan",
    )
    server._wait_for_shell_response(f"to allocate buffer for SDU",timeout=5)
    ...
    logger.info(f'server recv data3')
...
def test_l2cap_fc_mode_TC04(client, server):
    ...
    client._wait_for_shell_response(f" to allocate buffer for SDU",timeout=5)
    server._wait_for_shell_response(f"RNR p=0 f=0 on chan",timeout=5)
    ...
    logger.info(f'client recv data3')
    ...
    server.exec_command(
        f'l2cap_br send {L2CAP_CHAN_IUT_ID_RET} {data4}  {str(hex(len(data4)))[2:]}'
    )
