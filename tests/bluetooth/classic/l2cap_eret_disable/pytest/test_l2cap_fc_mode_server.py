...
def test_l2cap_fc_mode_TC01(client, server):
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_FC}, mode = basic, mode_option = false'
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_FC}, mode = basic, mode_option = true'
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_FC}, mode = ret, mode_option = false. stack do not support eret.',
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_FC))[2:]} ret', f'It is retransmission mode'
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_FC}, mode = ret, mode_option = true. stack do not support eret'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_FC))[2:]} ret {MODE_OPTION}',
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_FC}, mode = fc, mode_option = false. stack do not support eret.'
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_FC}, mode = fc, mode_option = true. stack do not support eret.'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_FC))[2:]} fc {MODE_OPTION}',
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_FC}, mode = stream, mode_option = false'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_FC))[2:]} stream',
        f'Channel {L2CAP_CHAN_IUT_ID_FC} disconnected',
    )

    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_FC}, mode = stream, mode_option = true.'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_FC))[2:]} stream {MODE_OPTION}',
        f'It is flow control mode',
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_FC}',
...
def test_l2cap_fc_mode_TC02(client, server):
    ...
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_FC))[2:]} stream', f'It is streaming mode'
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_FC}',
        f'Channel {L2CAP_CHAN_IUT_ID_FC} disconnected',
