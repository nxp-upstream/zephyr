...
def test_l2cap_ret_mode_TC01(client, server):
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = ret, mode_option = false. stack do not support eret.',
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = ret, mode_option = true. stack do not support eret'
    )
    client.iexpect(
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = fc, mode_option = false. stack do not support eret.'
    )
    client.iexpect(
        f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} fc', f'It is flow control mode'
    )
    client.iexpect(
        f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}',
        f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected',
    ...
    logger.info(
        f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = fc, mode_option = true. stack do not support eret.'
    )
    client.iexpect(
