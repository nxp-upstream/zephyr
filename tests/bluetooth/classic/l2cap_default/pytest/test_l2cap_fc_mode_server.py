...
def test_l2cap_fc_mode_TC01(client, server):
    ...
    logger.info(f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = ret, mode_option = false. stack support eret.',)
    client.iexpect(f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} ret', f'It is enhance retransmission mode')
    client.iexpect(f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}', f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected')

    logger.info(f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = ret, mode_option = true. stack support eret')
    client.iexpect(f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} ret {MODE_OPTION}', f'It is enhance retransmission mode')
    client.iexpect(f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}', f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected')

    logger.info(f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = fc, mode_option = false. stack support eret.')
    client.iexpect(f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} fc', f'It is enhance retransmission mode')
    client.iexpect(f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}', f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected')

    logger.info(f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = fc, mode_option = true. stack support eret.')
    client.iexpect(f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} fc {MODE_OPTION}', f'It is enhance retransmission mode')
    client.iexpect(f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}', f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected')

    logger.info(f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = eret, mode_option = false. stack support eret.')
    client.iexpect(f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} eret', f'It is enhance retransmission mode')
    client.iexpect(f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}', f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected')

    logger.info(f'client create l2cap. psm = {L2CAP_SERVER_PSM_RET}, mode = eret, mode_option = true. stack support eret.')
    client.iexpect(f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} eret {MODE_OPTION}', f'It is enhance retransmission mode')
    client.iexpect(f'l2cap_br disconnect {L2CAP_CHAN_IUT_ID_RET}', f'Channel {L2CAP_CHAN_IUT_ID_RET} disconnected')
    ...
    client.iexpect(f'l2cap_br connect {str(hex(L2CAP_SERVER_PSM_RET))[2:]} stream {MODE_OPTION}', f'It is enhance retransmission mode')
...
def test_l2cap_fc_mode_TC03(client, server):
    ...
    client.iexpect(f'l2cap_br send {L2CAP_CHAN_IUT_ID_RET} {data3}  {str(hex(len(data3)))[2:]}', f"RNR p=0 f=0 on chan")
