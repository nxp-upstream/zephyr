...
#define BTP_AVRCP_INFORM_DISPLAYABLE_CHAR_SET 0x10
struct btp_avrcp_inform_displayable_char_set_cmd {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_INFORM_BATT_STATUS_OF_CT 0x11
struct btp_avrcp_inform_batt_status_of_ct_cmd {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_GET_ELEMENT_ATTRS 0x12
...
#define BTP_AVRCP_GET_PLAY_STATUS 0x13
struct btp_avrcp_get_play_status_cmd {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_REGISTER_NOTIFICATION 0x14
...
#define BTP_AVRCP_REQ_CONTINUING_RSP 0x15
struct btp_avrcp_req_continuing_rsp_cmd {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_ABORT_CONTINUING_RSP 0x16
struct btp_avrcp_abort_continuing_rsp_cmd {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_SET_ABSOLUTE_VOLUME 0x17
struct btp_avrcp_set_absolute_volume_cmd {
	bt_addr_t address;
	uint8_t volume;
} __packed;

#define BTP_AVRCP_SET_ADDRESSED_PLAYER 0x18
struct btp_avrcp_set_addressed_player_cmd {
	bt_addr_t address;
	uint16_t player_id;
} __packed;

#define BTP_AVRCP_GET_FOLDER_ITEMS 0x19
...
#define BTP_AVRCP_GET_TOTAL_NUMBER_OF_ITEMS 0x1A
struct btp_avrcp_get_total_number_of_items_cmd {
	bt_addr_t address;
	uint8_t scope;
} __packed;

#define BTP_AVRCP_SET_BROWSED_PLAYER 0x1B
struct btp_avrcp_set_browsed_player_cmd {
	bt_addr_t address;
	uint16_t player_id;
} __packed;

#define BTP_AVRCP_CHANGE_PATH 0x1C
...
#define BTP_AVRCP_GET_ITEM_ATTRS 0x1D
...
#define BTP_AVRCP_PLAY_ITEM 0x1E
...
#define BTP_AVRCP_ADD_TO_NOW_PLAYING 0x20
...
#define BTP_AVRCP_GENERAL_REJECT 0x21
struct btp_avrcp_general_reject_cmd {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_TG_REGISTER_NOTIFICATION 0x22
struct btp_avrcp_tg_register_notification_cmd {
	bt_addr_t address;
	uint8_t event_id;
} __packed;

#define BTP_AVRCP_TG_CONTROL_PLAYBACK 0x23
...
#define BTP_AVRCP_TG_CHANGE_PATH 0x24
...
#define BTP_AVRCP_CA_CT_CONNECT 0x25
struct btp_avrcp_ca_ct_connect_cmd {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_CA_CT_DISCONNECT 0x26
struct btp_avrcp_ca_ct_disconnect_cmd {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_CA_CT_GET_IMAGE_PROPS 0x27
struct btp_avrcp_ct_get_image_props_cmd {
	bt_addr_t address;
	uint8_t image_handle[7];
} __packed;

#define BTP_AVRCP_CA_CT_GET_IMAGE 0x28
...
#define BTP_AVRCP_CA_CT_GET_LINKED_THUMBNAIL 0x29
...
#define BTP_AVRCP_EV_INFORM_DISPLAYABLE_CHAR_SET_RSP 0x8E
struct btp_avrcp_inform_displayable_char_set_rsp_ev {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_EV_INFORM_BATT_STATUS_OF_CT_RSP 0x8F
struct btp_avrcp_inform_batt_status_of_ct_rsp_ev {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_EV_GET_ELEMENT_ATTRS_RSP 0x90
...
#define BTP_AVRCP_EV_GET_PLAY_STATUS_RSP 0x91
...
#define BTP_AVRCP_EV_REGISTER_NOTIFICATION_RSP 0x92
...
#define BTP_AVRCP_EV_REQ_CONTINUING_RSP_RSP 0x93
struct btp_avrcp_req_continuing_rsp_rsp_ev {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_EV_ABORT_CONTINUING_RSP_RSP 0x94
struct btp_avrcp_abort_continuing_rsp_rsp_ev {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_EV_SET_ABSOLUTE_VOLUME_RSP 0x95
...
#define BTP_AVRCP_EV_SET_ADDRESSED_PLAYER_RSP 0x96
struct btp_avrcp_set_addressed_player_rsp_ev {
	bt_addr_t address;
	uint8_t status;
} __packed;

#define BTP_AVRCP_EV_GET_FOLDER_ITEMS_RSP 0x97
...
#define BTP_AVRCP_EV_GET_TOTAL_NUMBER_OF_ITEMS_RSP 0x98
...
#define BTP_AVRCP_EV_SET_BROWSED_PLAYER_RSP 0x99
...
#define BTP_AVRCP_EV_CHANGE_PATH_RSP 0x9A
...
#define BTP_AVRCP_EV_GET_ITEM_ATTRS_RSP 0x9B
...
#define BTP_AVRCP_EV_PLAY_ITEM_RSP 0x9C
struct btp_avrcp_play_item_rsp_ev {
	bt_addr_t address;
	uint8_t status;
} __packed;

#define BTP_AVRCP_EV_SEARCH_RSP 0x9D
...
#define BTP_AVRCP_EV_ADD_TO_NOW_PLAYING_RSP 0x9E
struct btp_avrcp_add_to_now_playing_rsp_ev {
	bt_addr_t address;
	uint8_t status;
} __packed;

#define BTP_AVRCP_EV_GENERAL_REJECT_RSP 0x9F
struct btp_avrcp_general_reject_rsp_ev {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_EV_CA_CT_CONNECTED 0xA0
struct btp_avrcp_ca_ct_connected_ev {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_EV_CA_CT_DISCONNECTED 0xA1
struct btp_avrcp_ca_ct_disconnected_ev {
	bt_addr_t address;
} __packed;

#define BTP_AVRCP_EV_GET_IMAGE_PROPS_RSP 0xA2
...
#define BTP_AVRCP_EV_GET_IMAGE_RSP 0xA3
...
#define BTP_AVRCP_EV_GET_LINKED_THUMBNAIL_RSP 0xA4
