...
static void hf_clip(struct bt_hfp_hf_call *call, char *number, uint8_t type)
{
	...
	tester_rsp_buffer_allocate(sizeof(*ev) + BTP_HFP_HF_PHONE_NUMBER_MAX_LEN, &buf);
...
#if defined(CONFIG_BT_HFP_HF_VOICE_TAG)
...
#endif /* CONFIG_BT_HFP_HF_VOICE_TAG */
