...
#define NODE1 DT_NODELABEL(icm42686_0)
#define NODE2 DT_NODELABEL(icm42688_0)

DEFINE_FFF_GLOBALS;

struct icm42686_fixture {
...
static void *icm42686_setup(void)
{
	static struct icm42686_fixture fixture = {
		.dev = DEVICE_DT_GET(NODE1),
		.target = EMUL_DT_GET(NODE1),
	};
...
static void *icm42688_setup(void)
{
	static struct icm42688_fixture fixture = {
		.dev = DEVICE_DT_GET(NODE2),
		.target = EMUL_DT_GET(NODE2),
	};
...
ZTEST_SUITE(icm42686, NULL, icm42686_setup, NULL, NULL, NULL);

ZTEST_F(icm42686, test_fetch_fail_no_ready_data)
{
	uint8_t status = 0;
...
static void test_fetch_temp_mc_icm42686(const struct icm42686_fixture *fixture,
...
static void test_fetch_temp_mc_icm42688(const struct icm42688_fixture *fixture,
		int16_t temperature_mc)
{
	struct sensor_value value;
	int64_t expected_uc;
...
ZTEST_F(icm42686, test_fetch_temp)
{
	/* Test 22.5C */
	test_fetch_temp_mc_icm42686(fixture, 22500);
	/* Test -3.175C */
	test_fetch_temp_mc_icm42686(fixture, -3175);
}

ZTEST_F(icm42688, test_fetch_temp)
{
	/* Test 22.5C */
	test_fetch_temp_mc_icm42688(fixture, 22500);
	/* Test -3.175C */
	test_fetch_temp_mc_icm42688(fixture, -3175);
}

static void test_fetch_accel_with_range_icm42686(const struct icm42686_fixture *fixture,
...
static void test_fetch_accel_with_range_icm42688(const struct icm42688_fixture *fixture,
					int16_t accel_range_g, const int16_t accel_percent[3])
{
	struct sensor_value values[3];
	int32_t expect_ug;
...
ZTEST_F(icm42686, test_fetch_accel)
{
	...
	test_fetch_accel_with_range_icm42686(fixture, 2, accel_percent);
	test_fetch_accel_with_range_icm42686(fixture, 4, accel_percent);
	test_fetch_accel_with_range_icm42686(fixture, 8, accel_percent);
	test_fetch_accel_with_range_icm42686(fixture, 16, accel_percent);
	test_fetch_accel_with_range_icm42686(fixture, 32, accel_percent);
}
...
ZTEST_F(icm42688, test_fetch_accel)
{
	...
	test_fetch_accel_with_range_icm42688(fixture, 2, accel_percent);
	test_fetch_accel_with_range_icm42688(fixture, 4, accel_percent);
	test_fetch_accel_with_range_icm42688(fixture, 8, accel_percent);
	test_fetch_accel_with_range_icm42688(fixture, 16, accel_percent);
}

static void test_fetch_gyro_with_range_icm42686(const struct icm42686_fixture *fixture,
		int32_t scale_mdps, const int16_t gyro_percent[3])
{
...
static void test_fetch_gyro_with_range_icm42688(const struct icm42688_fixture *fixture,
		int32_t scale_mdps, const int16_t gyro_percent[3])
{
	/* Set the epsilon to 0.075% of the scale */
	const int32_t epsilon_10udps = scale_mdps * 75 / 1000;
...
ZTEST_F(icm42686, test_fetch_gyro)
{
	...
	test_fetch_gyro_with_range_icm42686(fixture, 4000000, gyro_percent);
	test_fetch_gyro_with_range_icm42686(fixture, 2000000, gyro_percent);
	test_fetch_gyro_with_range_icm42686(fixture, 1000000, gyro_percent);
	test_fetch_gyro_with_range_icm42686(fixture, 500000, gyro_percent);
	test_fetch_gyro_with_range_icm42686(fixture, 250000, gyro_percent);
	test_fetch_gyro_with_range_icm42686(fixture, 125000, gyro_percent);
	test_fetch_gyro_with_range_icm42686(fixture, 62500, gyro_percent);
	test_fetch_gyro_with_range_icm42686(fixture, 31250, gyro_percent);
}
...
ZTEST_F(icm42688, test_fetch_gyro)
{
	...
	test_fetch_gyro_with_range_icm42688(fixture, 2000000, gyro_percent);
	test_fetch_gyro_with_range_icm42688(fixture, 1000000, gyro_percent);
	test_fetch_gyro_with_range_icm42688(fixture, 500000, gyro_percent);
	test_fetch_gyro_with_range_icm42688(fixture, 250000, gyro_percent);
	test_fetch_gyro_with_range_icm42688(fixture, 125000, gyro_percent);
	test_fetch_gyro_with_range_icm42688(fixture, 62500, gyro_percent);
	test_fetch_gyro_with_range_icm42688(fixture, 31250, gyro_percent);
	test_fetch_gyro_with_range_icm42688(fixture, 15625, gyro_percent);
}

FAKE_VOID_FUNC(test_interrupt_trigger_handler, const struct device*, const struct sensor_trigger*);

ZTEST_F(icm42686, test_interrupt)
{
	const struct gpio_dt_spec spec = GPIO_DT_SPEC_GET(NODE1, int_gpios);
...
{
	const struct gpio_dt_spec spec = GPIO_DT_SPEC_GET(NODE2, int_gpios);
	const struct sensor_trigger trigger = {
		.type = SENSOR_TRIG_DATA_READY,
		.chan = SENSOR_CHAN_ALL,
	};
