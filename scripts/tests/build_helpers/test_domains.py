...
""",
        ...
        [],
        {
            ...
            "domains": [
                {
                    ...
                    "build_dir": os.path.join(
                        SAMPLE_TOP_BUILD_DIR, "static_vrings"
                    ),
                },
                {
                    "name": "remote",
            ...
            "flash_order": ["static_vrings", "remote"],
        },
    ),
]
...
@pytest.mark.parametrize(
    (
        ...
        "expected_logs, expected_init_arg"
    ),
    TESTDATA_FROM_FILE,
    ids=["no file", "relative build dirs"],
)
def test_from_file(
    caplog,
    f_contents,
    ...
    if exit_code:
        ...
        init_mock.assert_called_once_with(expected_init_arg)
