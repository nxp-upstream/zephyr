...
/**
 * @file
 * @brief System/hardware module for nxp kw45 platform
 *
 * This module provides routines to initialize and support
 * hardware for the nxp kw45 platform
 */
...
#endif
#if (DT_NODE_HAS_COMPAT_STATUS(DT_NODELABEL(lpspi0), nxp_lpc_lpspi, okay)) && CONFIG_SPI
	CLOCK_EnableClock(kCLOCK_Lpspi0);
#endif
#if (DT_NODE_HAS_COMPAT_STATUS(DT_NODELABEL(lpspi1), nxp_lpc_lpspi, okay)) && CONFIG_SPI
	CLOCK_EnableClock(kCLOCK_Lpspi1);
#endif
#if CONFIG_CAN_MCUX_FLEXCAN
...
SYS_INIT(nxp_kw45_init, PRE_KERNEL_1, 0);
