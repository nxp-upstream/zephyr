...
static int soc_init(void)
{
	...
	clk_cfg.rate[0] = video1pll_vco_clk & 0xffffffff;
	clk_cfg.rate[1] = (video1pll_vco_clk >> 32) & 0xffffffff;
	...
	clk_cfg.rate[0] = video1pll_clk & 0xffffffff;
	clk_cfg.rate[1] = (video1pll_clk >> 32) & 0xffffffff;
