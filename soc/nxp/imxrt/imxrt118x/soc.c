	...
	.array = {
		{
			...
			(uint32_t)_flash_used - CONFIG_CONTAINER_USER_IMAGE_OFFSET - CONFIG_IMAGE_CONTAINER_OFFSET,
			(uint32_t)__rom_region_start + CONFIG_CONTAINER_USER_IMAGE_OFFSET + CONFIG_IMAGE_CONTAINER_OFFSET,
			0x00000000,
			(uint32_t)__start,
			0x00000000,
			IMG_FLAGS,
