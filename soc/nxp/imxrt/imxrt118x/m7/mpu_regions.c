...
#define REGION_DEFAULT_BASE_ADDRESS    0x00000000
#define REGION_DEFAULT_SIZE            REGION_4G
...
static const struct arm_mpu_region mpu_regions[] = {
	MPU_REGION_ENTRY("DEFAULT", REGION_DEFAULT_BASE_ADDRESS, REGION_IO_ATTR(REGION_DEFAULT_SIZE)),
