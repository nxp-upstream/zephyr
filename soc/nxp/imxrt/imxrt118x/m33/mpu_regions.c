...
#define REGION_OCRAM2_SHM_BASE_ADDRESS 0x20500000
#define REGION_OCRAM2_SHM_SIZE         0x00008000
...
static const struct arm_mpu_region mpu_regions[] = {
	...
	MPU_REGION_ENTRY("OCRAM2", REGION_OCRAM2_SHM_BASE_ADDRESS,
			 REGION_RAM_NOCACHE_ATTR(REGION_OCRAM2_SHM_BASE_ADDRESS, REGION_OCRAM2_SHM_SIZE)),
	MPU_REGION_ENTRY(
