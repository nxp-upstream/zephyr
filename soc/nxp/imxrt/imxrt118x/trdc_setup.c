...
static void board_request_trdc(bool request_aon, bool request_wakeup, bool request_mega)
{
	status_t sts;
...
{
	/* SDK board.c: BOARD_GrantTRDCFullPermissions() */

	/* 1. Request TRDC ownership */
	board_request_trdc(true, true, true);
