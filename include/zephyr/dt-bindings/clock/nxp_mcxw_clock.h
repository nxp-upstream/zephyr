...
#define MCXW_CLK_DIV_BY_1  1  /* kSCG_SysClkDivBy1 */
#define MCXW_CLK_DIV_BY_2  2  /* kSCG_SysClkDivBy2 */
#define MCXW_CLK_DIV_BY_3  3  /* kSCG_SysClkDivBy3 */
#define MCXW_CLK_DIV_BY_4  4  /* kSCG_SysClkDivBy4 */
#define MCXW_CLK_DIV_BY_5  5  /* kSCG_SysClkDivBy5 */
#define MCXW_CLK_DIV_BY_6  6  /* kSCG_SysClkDivBy6 */
#define MCXW_CLK_DIV_BY_7  7  /* kSCG_SysClkDivBy7 */
#define MCXW_CLK_DIV_BY_8  8  /* kSCG_SysClkDivBy8 */
#define MCXW_CLK_DIV_BY_10 10 /* kSCG_SysClkDivBy10 */
#define MCXW_CLK_DIV_BY_16 16 /* kSCG_SysClkDivBy16 */
...
#define MCXW_CLK_IP_MUX_FRO_192M 3 /* kCLOCK_IpSrcFro192M, FRO 192M clock. */
...
#define MCUX_CLK_IP_MUX_NONE     0xFF

/* clock control flags - matches kCLOCK_IpClkControl_xxx from clock driver. */
#define MCXW_CLK_CTRL_DISABLE 0  /* kCLOCK_IpClkControl_fun0  */
