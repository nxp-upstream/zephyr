 ...
 *
 * @type:	Storage classification hint (e.g. EEPROM, OTP). Used by upper
 *		layers for diagnostics and policy defaults; providers still
 *		enforce hardware semantics (such as OTP 1->0 programming) in
 ...
 *
 * @note: Providers must enforce their semantics (e.g., OTP 1->0 only) and
