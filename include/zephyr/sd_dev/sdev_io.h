...
/**
 * @file
 * @brief SD Device Core Internal APIs
 *
...
/**
 * @brief SD Device Core APIs
 * @defgroup sd_dev_core SD Device Core APIs
...
/**
 * @brief Initialize SD device core subsystem
 *
 * This function initializes the core SD device subsystem for the
 * given card instance.
 *
 * @param card Pointer to SD device card instance
 *
 * @retval 0 on success
 * @retval -EINVAL if card is NULL
