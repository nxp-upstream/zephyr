...
static inline uint32_t gcd_u(uint32_t a, uint32_t b)
{
...
static inline int32_t gcd_s(int32_t a, int32_t b)
{
...
static inline uint32_t lcm_u(uint32_t a, uint32_t b)
{
	if (a == 0 || b == 0) {
		return 0;
	}
...
static inline int32_t lcm_s(int32_t a, int32_t b)
{
