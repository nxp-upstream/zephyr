 ...
 *       - data should point to a plain text string containing the tool result.
 *         The server wraps this into a single MCP TextContent item automatically.
 ...
 *
 * @return mcp_server_ctx_t on success, NULL on failure
 */
