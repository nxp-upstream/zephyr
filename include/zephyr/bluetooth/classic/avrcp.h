 ...
 */
typedef void(*notification_callback_t)(uint8_t event_id, struct bt_avrcp_event_data *data);
...
struct bt_avrcp_ct_cb {
	...
	*             pdu_id                                    parameter
	*  BT_AVRCP_PDU_ID_GET_CAPS                             bt_avrcp_get_caps_rsp
	*  BT_AVRCP_PDU_ID_LIST_PLAYER_APP_SETTING_ATTRS        bt_avrcp_list_app_setting_attr_rsp
	*  BT_AVRCP_PDU_ID_LIST_PLAYER_APP_SETTING_VALS         bt_avrcp_list_player_app_setting_vals_rsp
	*  BT_AVRCP_PDU_ID_GET_CURR_PLAYER_APP_SETTING_VAL	bt_avrcp_get_curr_player_app_setting_val_rsp
	*  BT_AVRCP_PDU_ID_SET_PLAYER_APP_SETTING_VAL		NULL
	*  BT_AVRCP_PDU_ID_GET_PLAYER_APP_SETTING_ATTR_TEXT	bt_avrcp_get_player_app_setting_attr_text_rsp
	*  BT_AVRCP_PDU_ID_GET_PLAYER_APP_SETTING_VAL_TEXT	bt_avrcp_get_player_app_setting_val_text_rsp
	...
	*  BT_AVRCP_PDU_ID_PLAY_ITEM			        status(uint8_t)
	*  BT_AVRCP_PDU_ID_ADD_TO_NOW_PLAYING		        status(uint8_t)
	 ...
	 */
	void (*set_absolute_volume_rsp)(struct bt_avrcp_ct *ct, uint8_t tid, uint8_t absolute_volume);
 ...
 *             pdu_id                                    parameter
 *  BT_AVRCP_PDU_ID_GET_CAPS                            bt_avrcp_get_caps_cmd
 *  BT_AVRCP_PDU_ID_LIST_PLAYER_APP_SETTING_ATTRS       NULL
 *  BT_AVRCP_PDU_ID_LIST_PLAYER_APP_SETTING_VALS        bt_avrcp_list_player_app_setting_vals_cmd
 *  BT_AVRCP_PDU_ID_GET_CURR_PLAYER_APP_SETTING_VAL	bt_avrcp_get_curr_player_app_setting_val_cmd
 *  BT_AVRCP_PDU_ID_SET_PLAYER_APP_SETTING_VAL		bt_avrcp_set_player_app_setting_val_cmd
 *  BT_AVRCP_PDU_ID_GET_PLAYER_APP_SETTING_ATTR_TEXT	bt_avrcp_get_player_app_setting_attr_text_cmd
 *  BT_AVRCP_PDU_ID_GET_PLAYER_APP_SETTING_VAL_TEXT	bt_avrcp_get_player_app_setting_val_text_cmd
 *  BT_AVRCP_PDU_ID_INFORM_DISPLAYABLE_CHAR_SET		bt_avrcp_inform_displayable_char_set_cmd
*   BT_AVRCP_PDU_ID_INFORM_BATT_STATUS_OF_CT	     	bt_avrcp_inform_batt_status_of_ct_cmd
 ...
 *  BT_AVRCP_PDU_ID_PLAY_ITEM			        bt_avrcp_play_item_cmd
 ...
 * @return 0 on success or error code.
 */
int bt_avrcp_ct_list_player_app_setting_vals(struct bt_avrcp_ct *ct, uint8_t tid, struct net_buf *buf);
...
struct bt_avrcp_tg_cb {
	...
	*  BT_AVRCP_PDU_ID_ADD_TO_NOW_PLAYING		        bt_avrcp_add_to_now_playing_cmd
	 ...
	 * @param buf Command buffer.
	 */
	void (*list_player_app_setting_vals_req)(struct bt_avrcp_tg *tg, uint8_t tid, struct net_buf *buf);

	/**
	 * @brief Callback for PDU ID BT_AVRCP_PDU_ID_GET_CURR_PLAYER_APP_SETTING_VAL.
	 *
	 * Called when the TG receives a vendor dependent command for GET_CURR_PLAYER_APP_SETTING_VAL.
	 *
	 * @param tg AVRCP TG connection object.
	 * @param tid The transaction label of the command.
	 * @param buf Command buffer.
	 */
	void (*get_curr_player_app_setting_val_req)(struct bt_avrcp_tg *tg, uint8_t tid, struct net_buf *buf);
	 ...
	 * @param buf Command buffer.
	 */
	void (*set_player_app_setting_val_req)(struct bt_avrcp_tg *tg, uint8_t tid, struct net_buf *buf);

	/**
	 * @brief Callback for PDU ID BT_AVRCP_PDU_ID_GET_PLAYER_APP_SETTING_ATTR_TEXT.
	 *
	 * Called when the TG receives a vendor dependent command for GET_PLAYER_APP_SETTING_ATTR_TEXT.
	 *
	 * @param tg AVRCP TG connection object.
	 * @param tid The transaction label of the command.
	 * @param buf Command buffer.
	 */
	void (*get_player_app_setting_attr_text_req)(struct bt_avrcp_tg *tg, uint8_t tid, struct net_buf *buf);

	/**
	 * @brief Callback for PDU ID BT_AVRCP_PDU_ID_GET_PLAYER_APP_SETTING_VAL_TEXT.
	 *
	 * Called when the TG receives a vendor dependent command for GET_PLAYER_APP_SETTING_VAL_TEXT.
	 *
	 * @param tg AVRCP TG connection object.
	 * @param tid The transaction label of the command.
	 * @param buf Command buffer.
	 */
	void (*get_player_app_setting_val_text_req)(struct bt_avrcp_tg *tg, uint8_t tid, struct net_buf *buf);
	 ...
	 * @param buf Command buffer.
	 */
	void (*inform_displayable_char_set_req)(struct bt_avrcp_tg *tg, uint8_t tid, struct net_buf *buf);
	 ...
	 * @param buf Command buffer.
	 */
	void (*inform_batt_status_of_ct_req)(struct bt_avrcp_tg *tg, uint8_t tid, struct net_buf *buf);
 ...
 * @param result Response type, indicating the status of the command (e.g., accepted, rejected).
 ...
 * @return 0 on success or error code.
 */
int bt_avrcp_tg_send_get_element_attrs_rsp(struct bt_avrcp_tg *tg, uint8_t tid, bt_avrcp_rsp_t result,
					   struct net_buf *buf);
 ...
 * @return 0 on success or error code.
 */
int bt_avrcp_tg_send_add_to_now_playing_rsp(struct bt_avrcp_tg *tg, uint8_t tid, bt_avrcp_rsp_t result,
					    uint8_t status);
#ifdef __cplusplus
}
#endif
