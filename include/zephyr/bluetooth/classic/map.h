...
enum __packed bt_map_supported_features {
	...
	BT_MAP_EXT_EVENT_REPORT_1_1 = BIT(6),
	/** Extended event version 1.2 */
	BT_MAP_EXT_EVENT_VERSION_1_2 = BIT(7),
	/** Message format version 1.1 */
	BT_MAP_MSG_FORMAT_VERSION_1_1 = BIT(8),
	/** Message listing format version 1.1 */
	BT_MAP_MSG_LISTING_FORMAT_VERSION_1_1 = BIT(9),
	/** Persistent message handle */
	BT_MAP_PERSISTENT_MSG_HANDLE = BIT(10),
	/** Database identifier */
	BT_MAP_DATABASE_ID = BIT(11),
	/** Folder version counter */
	BT_MAP_FOLDER_VERSION_CNTR = BIT(12),
	/** Conversation version counter */
	BT_MAP_CONVO_VERSION_CNTR = BIT(13),
	...
	BT_MAP_PBAP_CONTACT_CROSS_REF = BIT(16),
	...
	BT_MAP_SUPPORTED_FEATURES_CONNECT_REQ = BIT(19),
...
enum __packed bt_map_appl_param_tag_id {
	...
	/** New message (1 byte) */
	BT_MAP_APPL_PARAM_TAG_ID_NEW_MESSAGE = 0x0d,
	/** Notification status (1 byte) */
	BT_MAP_APPL_PARAM_TAG_ID_NOTIFICATION_STATUS = 0x0e,
	/** MAS instance ID (1 byte) */
	BT_MAP_APPL_PARAM_TAG_ID_MAS_INSTANCE_ID = 0x0f,
	/** Parameter mask (4 bytes) */
	BT_MAP_APPL_PARAM_TAG_ID_PARAMETER_MASK = 0x10,
	...
	BT_MAP_APPL_PARAM_TAG_ID_SUBJECT_LENGTH = 0x13,
	/** Charset (1 byte) */
	...
	BT_MAP_APPL_PARAM_TAG_ID_STATUS_INDICATOR = 0x17,
	/** Status value (1 byte) */
	BT_MAP_APPL_PARAM_TAG_ID_STATUS_VALUE = 0x18,
	/** MSE time (variable length) */
	BT_MAP_APPL_PARAM_TAG_ID_MSE_TIME = 0x19,
	/** Database identifier (variable, max 32 bytes) */
	BT_MAP_APPL_PARAM_TAG_ID_DATABASE_IDENTIFIER = 0x1a,
	/** Conversation listing version counter (variable, max 32 bytes) */
	BT_MAP_APPL_PARAM_TAG_ID_CONV_LISTING_VER_CNTR = 0x1b,
	/** Presence availability (1 byte) */
	BT_MAP_APPL_PARAM_TAG_ID_PRESENCE_AVAILABILITY = 0x1c,
	...
	BT_MAP_APPL_PARAM_TAG_ID_CONVERSATION_ID = 0x22,
 ...
 */
enum __packed bt_map_filter_message_type {
	/** No filtering */
 ...
 */
enum __packed bt_map_new_message {
	/** Not a new message */
	BT_MAP_NEW_MESSAGE_OFF = 0x00,
	/** New message */
	BT_MAP_NEW_MESSAGE_ON = 0x01,
};
 ...
 */
enum __packed bt_map_notification_status {
	/** Notifications off */
	BT_MAP_NOTIFICATION_STATUS_OFF = 0x00,
	/** Notifications on */
	BT_MAP_NOTIFICATION_STATUS_ON = 0x01,
};
 ...
 */
enum __packed bt_map_parameter_mask {
	/** Subject */
	...
	/** Conversation ID */
	BT_MAP_PARAM_MASK_CONVERSATION_ID = BIT(17),
	/** Conversation name */
	BT_MAP_PARAM_MASK_CONVERSATION_NAME = BIT(18),
	/** Direction */
 ...
 */
enum __packed bt_map_status_indicator {
	/** Read status */
	BT_MAP_STATUS_INDICATOR_READ = 0x00,
	/** Deleted status */
	BT_MAP_STATUS_INDICATOR_DELETED = 0x01,
	/** Set extended data */
	BT_MAP_STATUS_INDICATOR_EXTENDED_DATA = 0x02,
};
 ...
 * New status value.
 */
enum __packed bt_map_status_value {
	/** No/Off */
	BT_MAP_STATUS_VALUE_NO = 0x00,
	/** Yes/On */
	BT_MAP_STATUS_VALUE_YES = 0x01,
};
 ...
 */
enum __packed bt_map_notification_filter_mask {
	/** NewMessage */
	BT_MAP_NTF_FILTER_MASK_NEW_MESSAGE = BIT(0),
	/** MessageDeleted */
	BT_MAP_NTF_FILTER_MASK_MESSAGE_DELETED = BIT(1),
	/** MessageShift */
	BT_MAP_NTF_FILTER_MASK_MESSAGE_SHIFT = BIT(2),
	/** SendingSuccess */
	...
	/** MemoryFull */
	BT_MAP_NTF_FILTER_MASK_MEMORY_FULL = BIT(7),
	/** MemoryAvailable */
	BT_MAP_NTF_FILTER_MASK_MEMORY_AVAILABLE = BIT(8),
	/** ReadStatusChanged */
	BT_MAP_NTF_FILTER_MASK_READ_STATUS_CHANGED = BIT(9),
	/** ConversationChanged */
	BT_MAP_NTF_FILTER_MASK_CONVERSATION_CHANGED = BIT(10),
	...
	BT_MAP_NTF_FILTER_MASK_MESSAGE_EXTENDED_DATA_CHANGED = BIT(13),
	/** MessageRemoved */
	BT_MAP_NTF_FILTER_MASK_MESSAGE_REMOVED = BIT(14),
};
 ...
 */
enum __packed bt_map_conversation_parameter_mask {
	/** Conversation name */
	BT_MAP_CONV_PARAM_MASK_CONVERSATION_NAME = BIT(0),
	/** Conversation last activity */
	BT_MAP_CONV_PARAM_MASK_CONVERSATION_LAST_ACTIVITY = BIT(1),
	/** Read status */
	BT_MAP_CONV_PARAM_MASK_READ_STATUS = BIT(2),
	/** Version counter */
	BT_MAP_CONV_PARAM_MASK_VERSION_COUNTER = BIT(3),
	/** Summary */
	BT_MAP_CONV_PARAM_MASK_SUMMARY = BIT(4),
	/** Participants */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANTS = BIT(5),
	/** Participant UCI */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_UCI = BIT(6),
	/** Participant display name */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_DISPLAY_NAME = BIT(7),
	/** Participant chat state */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_CHAT_STATE = BIT(8),
	/** Participant last activity */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_LAST_ACTIVITY = BIT(9),
	/** Participant X-BT-UID */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_X_BT_UID = BIT(10),
	/** Participant name */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_NAME = BIT(11),
	/** Participant presence availability */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_PRESENCE_AVAILABILITY = BIT(12),
	/** Participant presence text */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_PRESENCE_TEXT = BIT(13),
	/** Participant priority */
	BT_MAP_CONV_PARAM_MASK_PARTICIPANT_PRIORITY = BIT(14),
};
...
enum __packed bt_map_msg_extended_data {
	...
	BT_MAP_MSG_EXTENDED_DATA_FACEBOOK_LIKES = 0x00,
	/** Number of Twitter followers */
	BT_MAP_MSG_EXTENDED_DATA_TWITTER_FOLLOWERS = 0x01,
	/** Number of Twitter retweets */
	BT_MAP_MSG_EXTENDED_DATA_TWITTER_RETWEETS = 0x02,
	/** Number of Google +1s */
	BT_MAP_MSG_EXTENDED_DATA_GOOGLE_1S = 0x03,
};
