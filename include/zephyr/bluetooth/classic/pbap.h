...
struct bt_pbap_pce_cb {
	 ...
	 *
	 * if this callback is provided it will be called when the PCE set phone book
	 * response is received.
	 *
	 * @param pbap_pce The PBAP PCE object
	 * @param rsp_code Response code @ref bt_pbap_rsp_code
 ...
 *  @param nonce Output buffer to store the generated nonce (16 bytes)
 *
 *  @return 0 on success, negative error code on failure
 */
 ...
 *
 *  @param pwd Password string used for authentication (null-terminated)
 *  @param nonce Nonce value received in the authentication challenge (16 bytes)
 *  @param rsp_digest Output buffer to store the calculated response digest (16 bytes)
 *
 *  @return 0 on success, negative error code on failure
 */
 ...
 *
 *  @param nonce Nonce value that was sent in the authentication challenge (16 bytes)
 *  @param rsp_digest Response digest received from the authenticating peer (16 bytes)
 *  @param pwd Password string used for authentication (null-terminated)
 *
