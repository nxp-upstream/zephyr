...
/* PBAP PCE Supported features */
#if defined(CONFIG_BT_PBAP_PCE_DOWNLOAD)
/** @brief Enable download feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_DOWNLOAD_ENABLE BT_PBAP_SUPPORTED_FEATURE_DOWNLOAD
#else
/** @brief Disable download feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_DOWNLOAD_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_DOWNLOAD */

#if defined(CONFIG_BT_PBAP_PCE_BROWSING)
/** @brief Enable browsing feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_BROWSING_ENABLE BT_PBAP_SUPPORTED_FEATURE_BROWSING
#else
/** @brief Disable browsing feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_BROWSING_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_BROWSING */

#if defined(CONFIG_BT_PBAP_PCE_DATABASE_IDENTIFIER)
/** @brief Enable database identifier feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_DATABASE_IDENTIFIER_ENABLE BT_PBAP_SUPPORTED_FEATURE_DATABASE_IDENTIFIER
#else
/** @brief Disable database identifier feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_DATABASE_IDENTIFIER_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_DATABASE_IDENTIFIER */

#if defined(CONFIG_BT_PBAP_PCE_FOLDER_VERSION_COUNTERS)
/** @brief Enable folder version counters feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_FOLDER_VERSION_COUNTERS_ENABLE                                         \
	BT_PBAP_SUPPORTED_FEATURE_FOLDER_VERSION_COUNTERS
#else
/** @brief Disable folder version counters feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_FOLDER_VERSION_COUNTERS_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_FOLDER_VERSION_COUNTERS */

#if defined(CONFIG_BT_PBAP_PCE_VCARD_SELECTOR)
/** @brief Enable vCard selector feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_VCARD_SELECTOR_ENABLE BT_PBAP_SUPPORTED_FEATURE_VCARD_SELECTOR
#else
/** @brief Disable vCard selector feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_VCARD_SELECTOR_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_VCARD_SELECTOR */

#if defined(CONFIG_BT_PBAP_PCE_ENHANCED_MISSED_CALLS)
/** @brief Enable enhanced missed calls feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_ENHANCED_MISSED_CALLS_ENABLE                                           \
	BT_PBAP_SUPPORTED_FEATURE_ENHANCED_MISSED_CALLS
#else
/** @brief Disable enhanced missed calls feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_ENHANCED_MISSED_CALLS_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_ENHANCED_MISSED_CALLS */

#if defined(CONFIG_BT_PBAP_PCE_UCI_VCARD_PROPERTY)
/** @brief Enable UCI vCard property feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_UCI_VCARD_PROPERTY_ENABLE BT_PBAP_SUPPORTED_FEATURE_UCI_VCARD_PROPERTY
#else
/** @brief Disable UCI vCard property feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_UCI_VCARD_PROPERTY_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_UCI_VCARD_PROPERTY */

#if defined(CONFIG_BT_PBAP_PCE_UID_VCARD_PROPERTY)
/** @brief Enable UID vCard property feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_UID_VCARD_PROPERTY_ENABLE BT_PBAP_SUPPORTED_FEATURE_UID_VCARD_PROPERTY
#else
/** @brief Disable UID vCard property feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_UID_VCARD_PROPERTY_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_UID_VCARD_PROPERTY */

#if defined(CONFIG_BT_PBAP_PCE_CONTACT_REFERENCING)
/** @brief Enable contact referencing feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_CONTACT_REFERENCING_ENABLE BT_PBAP_SUPPORTED_FEATURE_CONTACT_REFERENCING
#else
/** @brief Disable contact referencing feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_CONTACT_REFERENCING_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_CONTACT_REFERENCING */

#if defined(CONFIG_BT_PBAP_PCE_DEFAULT_CONTACT_IMAGE)
/** @brief Enable default contact image feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_DEFAULT_CONTACT_IMAGE_ENABLE                                           \
	BT_PBAP_SUPPORTED_FEATURE_DEFAULT_CONTACT_IMAGE
#else
/** @brief Disable default contact image feature for PBAP PCE. */
#define BT_PBAP_PCE_FEATURE_DEFAULT_CONTACT_IMAGE_ENABLE 0
#endif /* CONFIG_BT_PBAP_PCE_DEFAULT_CONTACT_IMAGE */

/** @brief PBAP PCE supported features bitmask.
 *
 *  Combination of all enabled PBAP PCE features based on configuration.
 */
#define BT_PBAP_PCE_SUPPORTED_FEATURES                                                             \
	(BT_PBAP_PCE_FEATURE_DOWNLOAD_ENABLE | BT_PBAP_PCE_FEATURE_BROWSING_ENABLE |               \
	 BT_PBAP_PCE_FEATURE_DATABASE_IDENTIFIER_ENABLE |                                          \
	 BT_PBAP_PCE_FEATURE_FOLDER_VERSION_COUNTERS_ENABLE |                                      \
	 BT_PBAP_PCE_FEATURE_VCARD_SELECTOR_ENABLE |                                               \
	 BT_PBAP_PCE_FEATURE_ENHANCED_MISSED_CALLS_ENABLE |                                        \
	 BT_PBAP_PCE_FEATURE_UCI_VCARD_PROPERTY_ENABLE |                                           \
	 BT_PBAP_PCE_FEATURE_UID_VCARD_PROPERTY_ENABLE |                                           \
	 BT_PBAP_PCE_FEATURE_CONTACT_REFERENCING_ENABLE |                                          \
	 BT_PBAP_PCE_FEATURE_DEFAULT_CONTACT_IMAGE_ENABLE)

/** @brief PBAP supported repositories bitmask. */
enum bt_pbap_supported_respositiories {
