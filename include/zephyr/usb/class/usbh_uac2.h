...
/**
 * @brief Audio control request codes (Audio 2.0)
 */
/** Current value request */
#define USBH_AUDIO_CUR					0x01
/** Range request */
#define USBH_AUDIO_RANGE				0x02
/** Memory request */
#define USBH_AUDIO_MEM					0x03

/* Request direction */
/** GET request direction */
#define USBH_AUDIO_REQUEST_GET				0x80
/** SET request direction */
#define USBH_AUDIO_REQUEST_SET				0x00

/** GET current value */
#define USBH_AUDIO_GET_CUR				(USBH_AUDIO_REQUEST_GET | USBH_AUDIO_CUR)
/** SET current value */
#define USBH_AUDIO_SET_CUR				(USBH_AUDIO_REQUEST_SET | USBH_AUDIO_CUR)
/** GET range */
#define USBH_AUDIO_GET_RANGE				(USBH_AUDIO_REQUEST_GET | USBH_AUDIO_RANGE)
/** SET range */
#define USBH_AUDIO_SET_RANGE				(USBH_AUDIO_REQUEST_SET | USBH_AUDIO_RANGE)

/**
 * @brief Mute control values
 */
/** Unmute */
#define USBH_AUDIO_UNMUTE				0
/** Mute on */
#define USBH_AUDIO_MUTE_ON				1
