...
.. zephyr-app-commands::
   ...
   :board: mr_canhubk3/s32k344/mcuboot
   :goals: build
   :build-dir: build
   :gen-args: --sysbuild
   :compact:
...
.. zephyr-app-commands::
   ...
   :goals: build
   :build-dir: build
   :gen-args: --sysbuild -- -DSB_CONFIG_BOOT_SIGNATURE_TYPE_RSA=y -DSB_CONFIG_BOOT_SIGNATURE_KEY_FILE="$PWD/bootloader/mcuboot/root-rsa-2048.pem"
   :compact:
...
.. zephyr-app-commands::
   ...
   :goals: flash
   :gen-args: --sysbuild
   :flash-args: --domain mcuboot -r jlink
   :compact:
