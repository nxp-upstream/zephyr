...
NXP i.MX93 QSB (Cortex-A55)
############################

Overview
********

The i.MX93 Quick Start Board (MCIMX93-QSB board) is a platform designed to show
the most commonly used features of the i.MX 93 Applications Processor in a
small and low cost package. The MCIMX93-QSB board is an entry-level development
...
The Zephyr mimx93_qsb board configuration supports the following hardware
features:
...
.. code-block:: console
    ...
    *** Booting Zephyr OS build zephyr-v3.3.0-979-g245df7ae67c6  ***
    thread_a: Hello World from cpu 0 on mimx93_qsb_a55!
    thread_b: Hello World from cpu 0 on mimx93_qsb_a55!
    thread_a: Hello World from cpu 0 on mimx93_qsb_a55!
    thread_b: Hello World from cpu 0 on mimx93_qsb_a55!
