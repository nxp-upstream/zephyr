...
int main(void)
{
	...
	struct mp_caps *filtered_caps = mp_caps_new(
		MP_MEDIA_VIDEO_RAW, MP_CAPS_IMAGE_WIDTH, MP_TYPE_UINT, 640, MP_CAPS_IMAGE_HEIGHT,
		MP_TYPE_UINT, 480, MP_CAPS_FRAME_RATE, MP_TYPE_UINT_FRACTION, 60, 1, MP_CAPS_END);
