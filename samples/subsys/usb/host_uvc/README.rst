...
- :kconfig:option:`CONFIG_VIDEO_PIXEL_FORMAT` - Pixel format (YUYV, MJPEG, etc.)
- :kconfig:option:`CONFIG_VIDEO_FRAME_WIDTH` - Frame width
- :kconfig:option:`CONFIG_VIDEO_FRAME_HEIGHT` - Frame height
- :kconfig:option:`CONFIG_VIDEO_TARGET_FPS` - Target frame rate
...
- :kconfig:option:`CONFIG_VIDEO_FRAME_WIDTH` - Reduce frame width to lower memory usage
- :kconfig:option:`CONFIG_VIDEO_FRAME_HEIGHT` - Reduce frame height to lower memory usage
...
- :kconfig:option:`CONFIG_VIDEO_TARGET_FPS`
- :kconfig:option:`CONFIG_USBH_VIDEO_CONCURRENT_TRANSFERS`
- :kconfig:option:`CONFIG_VIDEO_FRAME_WIDTH`
- :kconfig:option:`CONFIG_VIDEO_FRAME_HEIGHT`
...
If video playback is slow or choppy, you can try to reduce the data rate or logging,
