...
This is a simple demo, which allows an SCMI agent running Zephyr to
print information about and configure parts of the system by interacting
with the SCMI platform using various protocols.
