...
static void app_convert_yuv420_to_rgb565(uint16_t width, uint16_t height, uint32_t yAddr,
			...
			struct video_buffer **out_buf)
{
	...
	app_convert_yuv420_to_rgb565(CONFIG_VIDEO_FRAME_WIDTH, CONFIG_VIDEO_FRAME_HEIGHT,
