...
if("${SB_CONFIG_RT700_DUAL_CORE_PM_REMOTE_BOARD}" STREQUAL "")
...
ExternalZephyrProject_Add(
  ...
  BOARD ${SB_CONFIG_RT700_DUAL_CORE_PM_REMOTE_BOARD}
  BOARD_REVISION ${BOARD_REVISION}
)

set_config_int(${DEFAULT_IMAGE} CONFIG_RT700_DUAL_CORE_PM_SLEEP_SECONDS
  ${SB_CONFIG_RT700_DUAL_CORE_PM_SLEEP_SECONDS})
set_config_int(${REMOTE_APP} CONFIG_RT700_DUAL_CORE_PM_SLEEP_SECONDS
  ${SB_CONFIG_RT700_DUAL_CORE_PM_SLEEP_SECONDS})
